...
try:
    from tkb_geonode_project.local_settings import *
except ImportError:
    from tkb_geonode_project.settings import *
...
def _reset():
    ...
    sh(f"rm -rf {path}")
    sh("rm -rf tkb_geonode_project/development.db")
    sh("rm -rf tkb_geonode_project/uploaded/*")
    _configure_data_dir()
