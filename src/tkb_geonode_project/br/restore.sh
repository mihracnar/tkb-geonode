...
echo "-----------------------------------------------------"
echo "STARTING tkb_geonode_project RESTORE $(date)"
echo "-----------------------------------------------------"
...
cd /usr/src/tkb_geonode_project/
...
SOURCE_URL=$SOURCE_URL TARGET_URL=$TARGET_URL ./tkb_geonode_project/br/backup.sh $BKP_FOLDER_NAME/$NEW_UUID
...
echo "-----------------------------------------------------"
echo " - Original Backup of $TARGET_URL --> /$BKP_FOLDER_NAME/$NEW_UUID/"
echo "FINISHED tkb_geonode_project RESTORE $(date)"
echo "-----------------------------------------------------"
